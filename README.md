...
I'm a final-year Data Engineering and Data Science student at **ENSA Al Hoceima** with a passion for turning complex datasets into strategic insights. Currently interning at **STM (Tanger-Tétouan)**, I'm engineering real-time solutions—from building CDC pipelines with Kafka and Debezium feeding into PostgreSQL to debugging Airflow DAGs and even perfecting my homemade Moroccan mint ATAY 🍵.

---

### 🚀 Current Focus & Projects

- **Real-Time Parking Grid @ STM:** Implementing change data capture pipelines with Kafka and Debezium powering a PostgreSQL backend.
- **Web App & API Development:** Building a robust FastAPI backend with a React-based frontend in the pipeline.
- **ETL & Analytics Orchestration:** Crafting Airflow DAGs to extract, transform, and load data into a modern data warehouse.
- **Highlighted Project:** Processed Arabic legal documents using OCR, LLMs, and MongoDB—containerized with a FARM stack for human validation.
...
I'm always eager to connect—whether it's brainstorming Kafka solutions or chatting over a cup of mint ATAY!
